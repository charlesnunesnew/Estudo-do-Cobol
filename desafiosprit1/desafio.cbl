      ...
      ******************************************************************
       ...
       01 WS-COUNT.
           ...
           03 CONTADOR                   PIC 9(02) VALUE ZEROS.
      ...
      *             BLANK WHEN ZEROS.
       ...
       0001-PRINCIPAL SECTION.
           ...
           PERFORM 2000-VALIDARSENHA THRU 2001-FIMVALIDASENHA 8 TIMES.
       ...
       2000-VALIDARSENHA.
           ...
           ELSE
           IF CARACTER IS ALPHABETIC-UPPER
      ...
      **************** SENHA ********************************************
           ...
           IF FL-EMAIL1 IS NOT = 1 AND FL-EMAIL2 IS NOT = 1 THEN
               ...
               ACCEPT MOSTRA-ERRO
           ELSE
           IF WS-TOT-MINUSC < 1 THEN
              MOVE 'SENHA DEVE CONTER UMA LETRA MINUSCULA'
              TO WRK-MSGERRO
               ACCEPT MOSTRA-ERRO
               EXIT
           END-IF.
           ...
           IF TAM-STRINGSENHA < 8 THEN
              MOVE 'SENHA MINIMO 8 CHARACTERS' TO WRK-MSGERRO
               ACCEPT MOSTRA-ERRO
           ELSE
           IF WS-TOT-NUMERO < 1 THEN
              MOVE 'SENHA DEVE CONTER UM NUMERO'
              TO WRK-MSGERRO
               ACCEPT MOSTRA-ERRO
               EXIT
           END-IF.

           IF WS-TOT-MAIUSC < 1 THEN
              MOVE 'SENHA DEVE CONTER UMA LETRA MAIUSCULA'
              TO WRK-MSGERRO
               ACCEPT MOSTRA-ERRO
           ELSE
