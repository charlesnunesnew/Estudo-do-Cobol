      ...
      ******************************************
       ...
       FILE-CONTROL.
           SELECT CLIENTES ASSIGN TO 'D:\Charles\CLIENTES.DAT'
       ...
       01 TELA.
           05 LIMPA-TELA.
               ...
               10 LINE 28 COLUMN 01 pic x(20) ERASE EOL
                  BACKGROUND-COLOR 2.
       01 MENU.
           05 LINE 10 COLUMN 45 VALUE '========================'.
           05 LINE 11 COLUMN 45 VALUE '|                      |'.
           05 LINE 12 COLUMN 45 VALUE '| 1 - INCLUIR          |'.
           05 LINE 13 COLUMN 45 VALUE '| 2 - CONSULTA         |'.
           05 LINE 14 COLUMN 45 VALUE '| 3 - ALTERAR          |'.
           05 LINE 15 COLUMN 45 VALUE '| 4 - EXCLUIR          |'.
           05 LINE 16 COLUMN 45 VALUE '| 5 - RELATORIO        |'.
           05 LINE 17 COLUMN 45 VALUE '| X - SAIDA            |'.
           05 LINE 18 COLUMN 45 VALUE '| OPCAO.....:          |'.
           05 LINE 19 COLUMN 45 VALUE '|                      |'.
           05 LINE 18 COLUMN 58 USING WRK-OPCAO.
       ...
       5000-INCLUIR.
           ...
           ACCEPT TELA-REGISTRO.
             WRITE CLIENTES-REG
               INVALID KEY
                 MOVE 'ERRO: CADASTRO JA EXISTENTE' TO WRK-MSGERRO
                 ACCEPT MOSTRA-ERRO
             END-WRITE.
             ...
             ACCEPT CHAVE.
              ...
              IF CLIENTES-STATUS = 0
                  ...
                  REWRITE CLIENTES-REG
                   IF CLIENTES-STATUS = 0
                       MOVE 'REGISTRO ALERADO' TO WRK-MSGERRO
                       ACCEPT MOSTRA-ERRO
                   ELSE
             ...
             ACCEPT CHAVE.
              READ CLIENTES
               ...
               NOT INVALID KEY
                ...
                END-READ.
                    ACCEPT MOSTRA-ERRO.
                     IF WRK-TECLA = 'S' AND CLIENTES-STATUS = 0 THEN
                         DELETE CLIENTES
                          INVALID KEY
